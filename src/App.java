...
class App {
  public static void main(String[] args) {
    ...
    System.out.println(meuPerfil.getListaDesejos(0) == minhaLista);
    System.out.println(meuPerfil.getListaDesejos("Minha lista") == minhaLista);
    // se não existe devolve null
    System.out.println(meuPerfil.getListaDesejos(1) == null);
    System.out.println(meuPerfil.getListaDesejos("Uma lista que não existe") == null);
    ...
    meuPerfil.getListaDesejos(0).adicionar(livroPequenoTratado); // ou navegando no grafo
